 ...
 * are allowed to response can be set with {@link #setTargetApplications(Collection)}. For example, set to
 ...
 * {@link com.google.zxing.BarcodeFormat#PDF_417}. Use {@link #initiateScan(java.util.Collection)} with a collection
...
public class IntentIntegrator {
    ...
    public static final int REQUEST_CODE_SCAN_CODE = 0x0000c0de; // Only use bottom 16 bits (this is 49374)
    public static final int REQUEST_CODE_SHARE_TEXT = 0x0000c0ef; // Only use bottom 16 bits (this is 49391)
    ...
    private static final String BS_PACKAGE_FOR_LMU = "com.google.zxing.lmu.client.android";
    ...
    public AlertDialog initiateScan(Collection<String> desiredBarcodeFormats) {
        ...
        startActivityForResult(intentScan, REQUEST_CODE_SCAN_CODE);
        return null;
    }
     ...
     * </p>
     * 
     * @return null if the event handled here was not related to this class, or else an {@link IntentResult} containing
    ...
    public AlertDialog shareText(CharSequence text, CharSequence type) {
        ...
        activity.startActivityForResult(intent, REQUEST_CODE_SHARE_TEXT);
        return null;
    }
